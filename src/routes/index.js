...
export const publicRoutes = [
    ...
    { path: '/accounts/detail/:userId', protected: true, page: AccountDetail, layout: MainLayout },
    { path: '/activation/:userId', page: Activation, layout: WrapLayout },
    { path: '/verified-account/:userId', page: AccountVerification, layout: WrapLayout },
